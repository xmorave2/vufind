...
use VuFind\View\Helper\Bootstrap3\LayoutClass as Bootstrap3LayoutClass;
 ...
 * @link     http://vufind.org/wiki/vufind2:developer_manual Wiki
 */
class LayoutClass extends Bootstrap3LayoutClass
{
    /**
    ...
    public function __invoke($class)
    {
        switch ($class) {
        case 'mainbody':
            return $this->left ? 'col-md-9 col-md-pull-3 mainbody' : 'col-md-9 mainbody';
        case 'sidebar':
            return $this->left
